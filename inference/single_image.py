...
jsonl_path = '/mnt/afs/xueyingyi/meme/generate/user_input.jsonl'
model_path = '/mnt/afs/xueyingyi/model/generate_text_v1'
output_json_file='/mnt/afs/xueyingyi/meme/generate/C_few_shot_eval.jsonl'
...
# 读取jsonl文件并处理每一行
    with open(jsonl_path, 'r') as file:
        for line in file:
            ...
            # 读取提示文本
            with open('/mnt/afs/xueyingyi/vl2.5/InternVL/inference/few_shot_no_image.txt', 'r') as prompt_file:
