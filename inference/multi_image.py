...
model_path = '/mnt/afs/xueyingyi/model/generate_few_shot_train'
output_json_file = '/mnt/afs/xueyingyi/meme/generate/generate_few_shot_train/C_few_shot_eval.jsonl'
