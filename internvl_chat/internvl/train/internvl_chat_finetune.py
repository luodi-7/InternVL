...
def write_to_file(label, result, filename="/mnt/afs/xueyingyi/test_ch_meme_v6/output.txt"):
...
def main():
    ...
    # 添加 pause token
    pause_tokens = [f'<pause_{i}>' for i in range(10)]  # 定义 pause token
    ...
    if num_new_tokens > 0:
        ...
        logger.info(f'Resized model embeddings to accommodate new tokens. New vocabulary size: {len(tokenizer)}')
