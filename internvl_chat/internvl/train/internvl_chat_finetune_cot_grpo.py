...
def write_to_file(label, result, filename="/fs-computility/ai-shen/xueyingyi/cot_box_text/output.txt"):
...
class GRPOTrainer(Trainer):
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        logits = model.compute_completion_logits(
            tokenizer=tokenizer,
            pixel_values=generation_output['expanded_pixel_values'],
